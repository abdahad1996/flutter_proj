                      ...
                      children: [
                        ...
                        Text(
                            todayWeatherModelList[index]
                                ...
                                .value
                                .toString() +
                                String.fromCharCode(0x00B0) + todayWeatherModelList[index]
                                .temperature
                                .unit,
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                        ...
                        Text(todayWeatherModelList[index].dateTime.contains('T') ?
                        todayWeatherModelList[index].dateTime.substring(0, todayWeatherModelList[index].dateTime.indexOf('T')) : '',
                            style: TextStyle(
                                fontWeight: FontWeight.normal,
                                color: Color(0xff222222),
                                fontSize: 11)),
                        ...
                        Text(todayWeatherModelList[index].dateTime.contains('T') ?
                        todayWeatherModelList[index].dateTime.substring(todayWeatherModelList[index].dateTime.indexOf('T')+1,
                      ...
                      children: [
                        ...
                        Text(
                            tomorrowWeatherModelList[index]
                                ...
                                .value
                                .toString() +
                                String.fromCharCode(0x00B0) + tomorrowWeatherModelList[index]
                                .temperature
                                .unit,
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                        ...
                        Text(tomorrowWeatherModelList[index].dateTime.contains('T') ?
                        tomorrowWeatherModelList[index].dateTime.substring(0, tomorrowWeatherModelList[index].dateTime.indexOf('T')) : '',
                            style: TextStyle(
                                fontWeight: FontWeight.normal,
                                color: Color(0xff222222),
                                fontSize: 11)),
                        ...
                        Text(tomorrowWeatherModelList[index].dateTime.contains('T') ?
                        tomorrowWeatherModelList[index].dateTime.substring(tomorrowWeatherModelList[index].dateTime.indexOf('T')+1,
                            tomorrowWeatherModelList[index].dateTime.length) : '',
                            style: TextStyle(
                                fontWeight: FontWeight.normal,
                                color: Color(0xff222222),
                                fontSize: 11)),
